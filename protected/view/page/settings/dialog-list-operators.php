...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var agentsScan = <?php echo ACJavaScript::encode(App::Config()->setting_schedule['agentid']); ?>;
        ...
        $('#dialog-operators input').change(function() {
            ...
            $.cookie('schedule_agentid', nvar.join(','));
...
<div id="dialog-operators" class="dialog hidden edit-content" title="Выберети операторов">
    <div style="margin: 0 15px;">
        ...
        foreach($agents as $key => $value) {
            $ckecked = (@in_array($key, App::Config()->setting_schedule['agentid'])) ? 'checked="checked"' : '';
            ?>
