...
// TODO Задача 6: Доработки
/*
1) Динамическое обновление супервизоров.
2) Счетчики времени должны тикать, все-таки.
3) Список очередей, в которых задействован оператор – под новую табличку?
4) Формула Service Level:  Service Level, % = Answered Less X seconds / Entered
5) Что означает 1000 по умолчанию рядом с галкой «Обновлять автоматом»? Секунды/миллисекунды?
*/
